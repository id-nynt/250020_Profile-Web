        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-300 mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0">
              Master of Computer Science student passionate about building innovative solutions 
              with modern technologies. Specializing in full-stack development, cloud computing, 
